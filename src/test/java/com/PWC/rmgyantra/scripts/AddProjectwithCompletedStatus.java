...
public class AddProjectwithCompletedStatus extends BaseClass {
	
@Test
	public void Completedstatus() throws SQLException {
		
		String projName="Api01"+JavaUtility.getRandomNum();
		pojoclass pObj=new pojoclass("KKKR",projName,10,"Completed");
